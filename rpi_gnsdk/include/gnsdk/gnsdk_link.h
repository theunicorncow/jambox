...
/** @internal gnsdk_link_content_image @endinternal
	  ...
	  *   #GNSDK_GDO_TYPE_VIDEO_SEASON, and #GNSDK_GDO_TYPE_CONTRIBUTOR.
	  *
...
/** @internal gnsdk_link_content_image_artist @endinternal
	  *
	  *   Retrieves an artist image for the object; this is Album-level content.
	  *
	  *   Use with #GNSDK_GDO_TYPE_ALBUM.
	  *
...
/** @internal gnsdk_link_query_status_t @endinternal
*  Indicates the Link callback function status values.
* @ingroup Link_TypesEnums
*/
typedef enum
{
/** @internal gnsdk_link_query_status_unknown @endinternal
	*
...
/** @internal gnsdk_link_query_status_begin @endinternal
	*
...
/** @internal gnsdk_link_query_status_connecting @endinternal
	*
	*   Indicates the Link library is connecting to the Gracenote Service.
	* @ingroup Link_TypesEnums
*/
	gnsdk_link_query_status_connecting,

/** @internal gnsdk_link_query_status_sending @endinternal
	*
	*   Indicates the Link library is performing redirects, sending headers and requests.
	* @ingroup Link_TypesEnums
*/
	gnsdk_link_query_status_sending,

/** @internal gnsdk_link_query_status_receiving @endinternal
	*
	*   Indicates the Link library is receiving headers and responses.
	* @ingroup Link_TypesEnums
*/
	gnsdk_link_query_status_receiving,

/** @internal gnsdk_link_query_status_query_complete @endinternal
	*
...
/** @internal gnsdk_link_callback_fn @endinternal
*  Link callback function for status updates as content is retrieved.
*  @param user_data [in] Pointer to data passed in to gnsdk_link_query_create function through the
...
*  @param link_query_handle [in] Link query handle that the callback operates on
*  @param status [in] One of gnsdk_link_query_status_t values
...
indicate progress, or 0 to indicate no progress.
*   p_abort [out] Set dereferenced value to GNSDK_TRUE to abort the operation that calls the
callback
* @ingroup Link_Callback
*/
...
*  @param callback_userdata [in_opt] Data that is provided via calls to the callback function
...
*  @param option_key [in] An option from the available Query Option Keys
...
*  @param option_key [in] An option from the available Query Option Values
...
/** @internal GNSDK_LINK_OPTION_LOOKUP_MODE @endinternal
  ...
  */
#define GNSDK_LINK_OPTION_LOOKUP_MODE				"gnsdk_link_lookup_mode"
...
*  Releases resources used for content data from <code>gnsdk_list_query_content_retrieve</code>.
*  @param buffer [in] Content buffer returned from <code>gnsdk_list_query_content_retrieve</code>
*  @return LINKERR_NotInited - <code>gnsdk_link_initialize</code> was not successfully initiated
