...
/** @internal gnsdk_video_status_t @endinternal
*  The status value of the current query, passed to gnsdk_video_callback_fn.
* @ingroup Video_TypesEnums
*/
typedef enum
{
/** @internal gnsdk_video_status_unknown @endinternal
*
*   Indicates a VideoID status value of unknown, the default state.
* @ingroup Video_TypesEnums
*/
	gnsdk_video_status_unknown = 0,

/**  @internal gnsdk_video_status_query_begin @endinternal
* @ingroup Video_TypesEnums
*/
	gnsdk_video_status_query_begin = 10,

/** @internal gnsdk_video_status_connecting @endinternal
*
*   Indicates a VideoID new query status value.
* @ingroup Video_TypesEnums
*/
	gnsdk_video_status_connecting = 20,

/** @internal gnsdk_video_status_sending @endinternal
*
*   Indicates a VideoID sending status value.
* @ingroup Video_TypesEnums
*/
	gnsdk_video_status_sending = 30,

/** @internal gnsdk_video_status_receiving @endinternal
*
*   Indicates a VideoID receiving status value.
* @ingroup Video_TypesEnums
*/
	gnsdk_video_status_receiving = 40,

/** @internal gnsdk_video_status_disconnected @endinternal
*
* @ingroup Video_TypesEnums
*/
	gnsdk_video_status_disconnected = 50,

/** @internal gnsdk_video_status_query_complete @endinternal
*
* @ingroup Video_TypesEnums
*/
	gnsdk_video_status_query_complete = 100,

/** @internal gnsdk_video_status_query_delete @endinternal
*
*   Indicates a VideoID query delete status value.
* @ingroup Video_TypesEnums
*/
	gnsdk_video_status_query_delete = 999
...
/** @internal gnsdk_video_callback_fn @endinternal
*  Receive status updates as Video data is retrieved.
*  @param callback_userdata [in] Pointer to data passed in to the gnsdk_video_query_create function
...
*  @param video_query_handle [in] Video query handle that the callback operates on
*  @param status [in] One of gnsdk_video_status_t values
...
*  @param option_key [in] An option from the available video option keys
...
*  @param option_key [in] One of the Video option keys to retrieve an option value for
...
/** @internal GNSDK_VIDEO_OPTION_ENABLE_LINK_DATA @endinternal
...
*
*  Link data is supported for the following GDO types:
*  <ul>
...
*  </ul>
*  All the listed types support these child and value GDOs:
*  <ul>
...
*  Through the GNSDK_GDO_TYPE_VIDEO_SEASON context, this function supports the
