...
*  @param option_key [in] One of the MusicID-File Option Keys for the option to set
...
*  @param option_key [in] One of the MusicID-File Option Keys to retrieve an option value for
...
* @ingroup Music_MusicIDFile_OptionKeys
*/
#define GNSDK_MUSICIDFILE_OPTION_LOOKUP_MODE				"gnsdk_midf_option_lookupmode"
...
*  <p><b>Remarks:</b></p>
*  To retrieve MediaVOCS data, define this option key with a True value for a specific MusicID-File
...
/** @internal GNSDK_MUSICIDFILE_OPTION_ENABLE_DSP_DATA @endinternal
*  Indicates whether a response should include any associated sonic attribute (DSP) data.
*  <p><b>Remarks:</b></p>
*  To retrieve DSP data, define this option key with a True value for a specific MusicID-File query
...
/** @internal GNSDK_MUSICIDFILE_OPTION_ENABLE_LINK_DATA @endinternal
...
*  To retrieve Link data, define this option key with a True value for a specific MusicID-File query
handle. This retrieves the data and automatically renders it into the XML output.
*  An application's license must be entitled to retrieve this specialized data. Contact your
Gracenote Professional Services representative with any questions about this enhanced functionality.
...
*  The response GDO (if available) is of a #GNSDK_GDO_TYPE_RESPONSE_ALBUM or #GNSDK_GDO_TYPE_RESPONSE_CONTRIBUTOR type.
...
*  <p><b>Remarks:</b></p>
*  This value is generally found in audio file tags that have been created by Apple iTunes™. For
...
*  CD TOCs are in the format: 150 2355 43789 89999 123456 …
* @ingroup Music_MusicIDFile_FileInfoValues
*/
...
fingerprint is given for identification, but no metadata, the result could be very strong—however,
...
gnsdk_musicidfile_fileinfo_status(
	...
	gnsdk_error_info_t**					pp_error_info
	);
