...
* @ingroup Playlist_AttributesFunctions
*/
gnsdk_error_t GNSDK_API
...
/* for backward compatability with GNSDK for Auto 1.0 release */
...
/** @internal gnsdk_playlist_collection_ident_exists @endinternal
*  Retrieves a boolean value indicating if an identifier exists for a Playlist Collection Summary.
*  An identifier must be unique and not duplicated. Use this function to determine if an identifier
 already exists in the collection summary.
*  @param h_collection [in] Handle to a collection summary
*  @param ident [in] String of identifier data
*  @param pb_ident_present [out] Pointer to receive boolean value indicating if the identifier is
associated with the collection summary
*  @return PLERR_NotInited gnsdk_playlist_initialize was not successfully initiated
*  @return PLERR_InvalidArg Given ident is empty, or given pb_ident_present is NULL
*  @return PLERR_NoError Ident was successfully determined to exist (TRUE) or not exist
*  (FALSE)
* @ingroup Playlist_CollectionSummaryFunctions
*/
gnsdk_error_t GNSDK_API
...
*  Retrieves the total number of identifiers associated with a Playlist Collection Summary.
*  @param h_collection [in] Handle to a collection summary
...
*  Use this function to iterate through the identifiers (0-n) contained in a collection summary.
*  @param h_collection [in] Handle to a collection summary
...
/** @internal gnsdk_playlist_collection_ident_get_gdo @endinternal
...
/** @internal GNSDK_GDO_TYPE_PLAYLIST_DATA @endinternal
  ...
  * name as attributes available Playlist.
  * @ingroup Playlist_CollectionSummaryFunctions
*/
...
*  @param user_handle [in] Handle to a user for the user requesting the playlist
*  @param pdl_statement [in] PDL statement string
*  @param h_collection [in] Handle to a Playlist collection summary
...
*  @param user_handle [in] Handle to a user for the user requesting the "More Like This" playlist
*  @param h_collection [in] Handle to a Playlist collection summary
...
/** @internal GNSDK_PLAYLIST_MORELIKETHIS_OPTION_RANDOM @endinternal
  * Option for querying/specifying the random value used in calculating a "More Like This" playlist.
  * The value for this key must evaluate to a number greater than 0. The recommended range is 1 - 100, but you
  * can choose any number. This number will be the seed for the randomization. You can re-create a playlist
  * by choosing the same number for the randomization seed. Choosing different numbers will create different playlists.
  * @ingroup Playlist_PlaylistGeneration_Options
*/
#define GNSDK_PLAYLIST_MORELIKETHIS_OPTION_RANDOM	        "gnsdk_playlist_morelikethis_option_random"
...
/** @internal gnsdk_playlist_storage_version_get @endinternal
*  Get version on named local storage.
*  @param p_version [out] String value for storage version.
*  @return GNSDK_SUCCESS or error
* @ingroup Playlist_StorageFunctions
*/
gnsdk_error_t GNSDK_API
gnsdk_playlist_storage_version_get(
	gnsdk_cstr_t*	p_version
	);
