...
*  @param render_flags [in] One or more GDO render flags to enable optional content in XML
*  @param p_xml_render [out] Pointer to the string that receives the rendered XML
*  @return SDKMGRERR_NotInited - <code>gnsdk_manager_initialize</code> was not successfully initiated
*  @return SDKMGRERR_InvalidArg - Given value for <code>gdo_handle</code> or <code>p_xml_render</code> parameter is null
*  @return SDKMGRERR_HandleObjectInvalid - Given GDO handle is not a valid handle
*  @return SDKMGRERR_HandleObjectWrongType - Given GDO handle is not a valid GDO handle type
*  @return SDKMGRERR_NoError - XML string was successfully rendered
*
*  <p><b>Remarks:</b></p>
*  Use this function with the GDO render flags to render data in a GDO to XML.<br>
*  Use <code>gnsdk_manager_string_free</code> to free the XML string when the application is finished using it.
* @ingroup GDO_Functions
*/
gnsdk_error_t GNSDK_API
...
*  GDO render flags can be combined to output multiple values to the XML.
* @ingroup GDO_RenderFlags
*/
#define GNSDK_GDO_RENDER_XML_SERIAL_GDOS			0x0010
/** @internal GNSDK_GDO_RENDER_XML_PRODUCT_IDS @endinternal
...
/** @internal GNSDK_GDO_RENDER_XML_DISCOVER_SEEDS @endinternal
...
/** @internal GNSDK_GDO_RENDER_XML_RAW_TUIS @endinternal
*  Renders any Gracenote TUI values into XML for a GDO.
* @ingroup GDO_RenderFlags
*/
#define GNSDK_GDO_RENDER_XML_RAW_TUIS				0x0080
/** @internal GNSDK_GDO_RENDER_XML_GNIDS @endinternal
  *
  * @ingroup GDO_RenderFlags
*/
#define GNSDK_GDO_RENDER_XML_GNIDS					0x0100
/** @internal GNSDK_GDO_RENDER_XML_GNUIDS @endinternal
  *
  * @ingroup GDO_RenderFlags
*/
#define GNSDK_GDO_RENDER_XML_GNUIDS					0x0200
/** @internal GNSDK_GDO_RENDER_XML_GENRE_LEVEL1 @endinternal
*  Renders any Gracenote genre values into XML for a GDO.
* @ingroup GDO_RenderFlags
*/
#define GNSDK_GDO_RENDER_XML_GENRE_LEVEL1			0x1000
/** @internal GNSDK_GDO_RENDER_XML_GENRE_LEVEL2 @endinternal
*  Renders any Gracenote meta-genre (coarser) values into XML for a GDO.
* @ingroup GDO_RenderFlags
*/
#define GNSDK_GDO_RENDER_XML_GENRE_LEVEL2			0x2000
/** @internal GNSDK_GDO_RENDER_XML_GENRE_LEVEL3 @endinternal
*  Renders any Gracenote micro-genre (finer) values into XML for a GDO.
* @ingroup GDO_RenderFlags
*/
#define GNSDK_GDO_RENDER_XML_GENRE_LEVEL3			0x4000

/** @internal GNSDK_GDO_RENDER_XML_DEFAULT @endinternal
*  Renders the default metadata into the XML for a GDO (identifiers not included).
*  <p><b>Remarks:</b></p>
*  Equivalent to the set of flags:
*  <ul>
*  <li>GNSDK_GDO_RENDER_XML_STANDARD</li>
*  <li>GNSDK_GDO_RENDER_XML_SERIAL_GDOS</li>
*  <li>GNSDK_GDO_RENDER_XML_GENRE</li>
*  </ul>
* @ingroup GDO_RenderFlags
*/
#define GNSDK_GDO_RENDER_XML_DEFAULT				(GNSDK_GDO_RENDER_XML_STANDARD|GNSDK_GDO_RENDER_XML_GENRE_LEVEL2)
/** @internal GNSDK_GDO_RENDER_XML_FULL @endinternal
*  Renders majority of metadata into the XML for a GDO (identifiers not included)
*  <p><b>Remarks:</b></p>
*  Equivalent to the set of flags:
*  <ul>
*  <li>GNSDK_GDO_RENDER_XML_DEFAULT<li>
*  <li>GNSDK_GDO_RENDER_XML_RAW_TUIS<li>
*  <li>GNSDK_GDO_RENDER_XML_CREDITS<li>
*  </ul>
* @ingroup GDO_RenderFlags
*/
#define GNSDK_GDO_RENDER_XML_FULL					(GNSDK_GDO_RENDER_XML_DEFAULT|GNSDK_GDO_RENDER_XML_CREDITS)

/** @internal GNSDK_GDO_RENDER_XML_SUBMIT @endinternal
*  Renders any Gracenote data supported for Submit editable GDOs into the XML for a GDO. This
rendered data includes both the supported editable and non-editable data.
* @ingroup GDO_RenderFlags
*/
#define GNSDK_GDO_RENDER_XML_SUBMIT					0x80000
...
*  Retrieves a boolean value indicating whether the match(es) need disambiguation.
* @ingroup GDO_ValueKeys_Misc
*/
...
*  GNSDK_GDO_TYPE_TRACK GDOs.
*  The ordinal parameter for gnsdk_manager_gdo_child_get with this key indicates the n'th matching
child track to retrieve. A child track is marked matching for some queries that can match to a
...
/** @internal GNSDK_GDO_CHILD_NAME_ALTERNATE @endinternal
  *
  *   Retrieves an alternate child name GDO.
* @ingroup GDO_ChildKeys_Name
*/
#define GNSDK_GDO_CHILD_NAME_ALTERNATE					GNSDK_GDO_TYPE_NAME"!alt"
...
/** @internal GNSDK_GDO_CHILD_TITLE_ALTERNATE @endinternal
  *
  *   Retrieves an alternate child title GDO.
* @ingroup GDO_ChildKeys_Title
*/
#define GNSDK_GDO_CHILD_TITLE_ALTERNATE					GNSDK_GDO_TYPE_TITLE"!alt"
...
the source query
*  <p><b>Remarks:</b></p>
*  Available for track types. This value is only available in response to queries that match to a
track type, such as text searching.
...
*  Retrieves a numeric value indicating the position (in milliseconds) in the Track where the GNFPX
fingerprint match occurs.
*  <p><b>Remarks:</b></p>
*  The Track Position Match value indicates at what track millisecond the GNFPX fingerprint begins
to match, and is returned by using gnsdk_manager_gdo_value_get.
* <p><b>Note:</b></p>
*   This value is retrieved only when using the GNFPX fingerprint data type.
*  These code examples show only two of several possible ways to retrieve a Track Position Match
value from Album and Track
*  GDOs.
*  Function call sequence using an Album GDO:
*  <ol>
*  <li>gnsdk_musicid_query_create
*  <li>gnsdk_musicid_query_fingerprint_begin
*  <li>gnsdk_musicid_query_fingerprint_write
*  <li>gnsdk_musicid_query_fingerprint_end
*  <li>gnsdk_musicid_query_find_albums
*  <li>gnsdk_sdkmanager_gdo_child_get(result_gdo, GNSDK_GDO_CHILD_ALBUM, 1, &album_gdo)
*  <li>gnsdk_sdkmanager_gdo_value_get(album_gdo,GNSDK_GDO_VALUE_TRACK_MATCHED_POSITION,1,...)
*  </ol>
*  When retrieving a Track Position Match value from a Track, use multiple calls to
gnsdk_sdkmanager_gdo_child_get to access the related Album GDO type from the Track GDO type.
*  Function call sequence using a Track GDO:
*  <ol>
*  <li> gnsdk_musicid_query_create
*  <li> gnsdk_musicid_query_fingerprint_begin
*  <li> gnsdk_musicid_query_fingerprint_write
*  <li> gnsdk_musicid_query_fingerprint_end
*  <li> gnsdk_musicid_query_find_tracks
*  <li> gnsdk_sdkmanager_gdo_child_get(result_gdo, GNSDK_GDO_CHILD_TRACK, 1, &track_gdo)
*  <li> gnsdk_sdkmanager_gdo_child_get(track_gdo, GNSDK_GDO_CHILD_ALBUM, 1, &album_gdo)
*  <li> gnsdk_sdkmanager_gdo_value_get(album_gdo,GNSDK_GDO_VALUE_TRACK_MATCHED_POSITION,1,...)
*  </ol>
*  You must be licensed and entitled for MusicID-Stream.
*  For questions on implementing this functionality or licensing, contact your Gracenote
...
object, for Album, Lyric, and
*  Track text results. The returned results are of the type GNSDK_GDO_TYPE_RESPONSE_*,
specifically:
*  <ul>
...
of the match to the given Album, Lyric, or Track result. Note the following:
*  <ul>
*  <li>The match score is only useful in comparison to other match scores; by itself, it does not
indicate a strong or poor match.
...
*  Retrieves a value indicating if a GDO contributor response result matched on the primary collaborator for the
input collaboration string. For example, if the input text was "John feat. Joe" and the returned contributor match
is the John's contributor object instead of the "John feat. Joe" collaboration contributor object.
Returns 1 if this is a collaborator match, 0 if not.
*  <p><b>Remarks:</b></p>
...
/** @internal GNSDK_GDO_VALUE_ARTISTTYPE_LEVEL1 @endinternal
  *
  *   Retrieves a type value from a GDO.
  * @ingroup GDO_ValueKeys_Misc
*/
...
information.
*
*  When retrieving classical music data, origin data may be available at the Album, Track, and
Composer credit level.
* @ingroup GDO_ValueKeys_Misc
*/
...
*/
#define GNSDK_GDO_VALUE_ACR_MATCH_POSITION_ACTUAL			"gnsdk_val_acr_match_position_actual"
...
* @ingroup GDO_ValueKeys_Acr
*/
#define GNSDK_GDO_VALUE_ACR_MATCH_POSITION_ADJUSTED			"gnsdk_val_acr_match_position_adjusted"
...
* @ingroup GDO_ValueKeys_Acr
*/
#define GNSDK_GDO_VALUE_ACR_MATCH_POSITION					"gnsdk_val_acr_match_position"
...
*  Retrieves the display language.
*
...
/** @internal GNSDK_GDO_VALUE_DISPLAY_LANGUAGE_DISPLAY @endinternal
  ...
  * @ingroup GDO_ValueKeys_Name
*/
#define GNSDK_GDO_VALUE_DISPLAY_LANGUAGE_DISPLAY		"gnsdk_val_pkglang_display"
