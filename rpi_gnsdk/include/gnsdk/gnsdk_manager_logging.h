...
*  @param mask [in] Filter mask of the type of log message
*  @param format [in] Format string of the log message
*  @param argptr [in] Set of arguments for the format string
*  <p><b>Remarks:</b></p>
...
*  Write to the log sychronously (on the same thread). By default
*  logs are written to asynchronously. No internal logging thread
*  is created if all logs are opened for synchronous writting.
* @ingroup Setup_Logging_Options
*/
