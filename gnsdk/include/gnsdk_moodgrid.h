/* Gracenote SDK Mood Grid public header file
  * Author:
...
/** @internal gnsdk_moodgrid_status_t @endinternal
  *
  * @ingroup MoodGrid_TypesEnums
  */
typedef enum
{
	/** @internal gnsdk_moodgrid_status_unknown @endinternal
	 *
	 *  Mood Grid presentation status is unknown.
	 * @ingroup MoodGrid_TypesEnums
	 */
	gnsdk_moodgrid_status_unknown = 0,


	/** @internal gnsdk_moodgrid_status_transaction_connecting @endinternal
	 *
	 *    Mood Grid is requesting a transaction connection.
	 * @ingroup MoodGrid_TypesEnums
	 */
	gnsdk_moodgrid_status_transaction_connecting = 10,


	/** @internal gnsdk_moodgrid_status_transaction_start @endinternal
	 *
	 *  Mood Grid is starting a datasource transaction.
	 * @ingroup MoodGrid_TypesEnums
	 */
	gnsdk_moodgrid_status_transaction_start   = 20,

	/** @internal gnsdk_moodgrid_status_transaction_request @endinternal
	 *
	 *  Mood Grid  is requesting recommendations in  a transaction.
	 * @ingroup MoodGrid_TypesEnums
	 */
	gnsdk_moodgrid_status_request = 30,

	/** @internal gnsdk_moodgrid_status_receiving @endinternal
	 *
	 * Mood Grid is receiving results for a transaction.
	 * @ingroup MoodGrid_TypesEnums
	 */
	gnsdk_moodgrid_status_receiving = 40,

	/** @internal gnsdk_moodgrid_status_connection_lost @endinternal
	 *
	 * If online, sent if the connection is lost or time out occurs.
	 * @ingroup MoodGrid_TypesEnums
	 */
	gnsdk_moodgrid_status_connection_lost = 50,

	/** @internal gnsdk_moodgrid_status_transaction_complete @endinternal
	 *
	 * Mood Grid has completed a transaction.
	 * @ingroup MoodGrid_TypesEnums
	 */
	gnsdk_moodgrid_status_transaction_complete   = 100

	} gnsdk_moodgrid_status_t;
...
/** @internal gnsdk_moodgrid_callback_fn @endinternal
  *
  *   Mood Grid callback function for status updates as content is retrieved.
  *
  * @param user_data					[in] Pointer to data passed in to gnsdk_moodgrid_presentation_create
  ...
  * @param moodgrid_presentation_handle	[in] The presentation handle that the callback operates on.
  * @param status						[in] One of gnsdk_moodgrid_status_t values.
  ...
  *
  * @ingroup MoodGrid_Callbacks
*/
typedef gnsdk_void_t
(GNSDK_CALLBACK_API *gnsdk_moodgrid_callback_fn)(
	gnsdk_void_t*							user_data,
	gnsdk_moodgrid_presentation_handle_t	moodgrid_presentation_handle,
	gnsdk_moodgrid_status_t					status,
...
gnsdk_moodgrid_presentation_create(
	...
	gnsdk_moodgrid_presentation_type_t		presentation_type,
	gnsdk_moodgrid_callback_fn				callback_fn,
