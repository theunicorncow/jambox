/* Gracenote SDK: GNSDK Manager Storage Public Header File
  * Author:
...
*   <li>The list storage, which stores Gracenote's display lists #GNSDK_MANAGER_STORAGE_LISTSCACHE
*  </ul>
...
*   <li>The content cache, which stores cover art and related information #GNSDK_MANAGER_STORAGE_CONTENTCACHE
*   <li>The query cache, which stores media identification requests #GNSDK_MANAGER_STORAGE_QUERYCACHE
*   <li>The list storage, which stores Gracenote display lists #GNSDK_MANAGER_STORAGE_LISTSCACHE
*  </ul>
*  Use the appropriate name to perform this operation on the target storage. Each of these require a
...
*
*  @param storage_name [in] Local storage name
*  @param p_valid [in] Boolean value to indicate whether the storage is valid.
*  @return SDKMGRERR_NotInited gnsdk_manager_initialize was not successfully initiated
...
/** @internal gnsdk_manager_storage_version_get @endinternal
*  Get the version of the named local storage.
*
*  @param storage_name [in] Local storage name
*  @param p_version [in] String value to indicate version.
*  @return SDKMGRERR_NotInited gnsdk_manager_initialize was not successfully initiated
*  @return SDKMGRERR_NoError Get version was successfully performed
*
* @ingroup StorageandCaching_General_Functions
*/
gnsdk_error_t GNSDK_API
gnsdk_manager_storage_version_get(
	gnsdk_cstr_t	storage_name,
...
* @ingroup StorageandCaching_General_StorageIDs
*/
#define GNSDK_MANAGER_STORAGE_LISTSCACHE		"gnsdk_storage_listscache"
