...
class my_ui(threading.Thread):
    def __init__(self, jukebox):
        ...
        self.track = None
        self.results = False
        self.queue = ['spotify:track:0SyXvJ6uRArVWHXUyi3FKO','spotify:track:3K73moFNGv3PVe7MXdyigl']

    def run(self):
        self.play_next()
        print "running"
        rec_button = GPIO_Button(28,self.fp_replace_queue)
        play_button = GPIO_Button(30,self.play_next)
    ...
    def replace_queue(self,newq):
        self.queue = newq
        return self.play_next()

    def fp_replace_queue(self):
        q = fingerprint.fp_to_tracks()
        if q:
            self.replace_queue(q)
...
if __name__ == '__main__':
    ...
    #l = Link.from_string('spotify:track:0SyXvJ6uRArVWHXUyi3FKO')
